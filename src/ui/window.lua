	...
	local function start_device_flow()
		...
		GLib.idle_add(GLib.PRIORITY_DEFAULT, function()
			...
			status_label:set_text(
				string.format("Please visit %s and enter code: %s", device_info.verification_uri, device_info.user_code)
			)
			...
			local function poll()
				...
				local token, token_err =
					self.api:poll_for_token(client_id, device_info.device_code, device_info.interval)
